...
selector_path = "/home/canveo/Projects/test_ros2/behavior_metrics/models/CARLA/curvature_selector.onnx"
straight_path = "/home/canveo/Projects/test_ros2/behavior_metrics/models/CARLA/efficientnet_recta.onnx"
curve_path = "/home/canveo/Projects/test_ros2/behavior_metrics/models/CARLA/efficientnet_curva.onnx"
...
class Brain:
    ...
    def predict_controls(self, image_seg):
        ...
        if is_curve:
            ...
            logger.debug("Modelo experto: Curva")
        else:
            pred = self.ort_straight.run([self.st_out], {self.st_in: input_expert})[0]
            logger.debug("Modelo experto: Recta")
